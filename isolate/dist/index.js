...
// ../src/merchant.js
function scrap(input) {
  const today = format(/* @__PURE__ */ new Date(), "'Today is a' eeee");
  console.log(input);
  return { today, foo: input.foo, bar: import_lodash.default.upperCase(input.bar) };
}

// index.js
function run() {
  console.log("Running");
  const output = scrap({ foo: "test", bar: "run" });
  console.log(output);
  console.log("Return");
}
run();
